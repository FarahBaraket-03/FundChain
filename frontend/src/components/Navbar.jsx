...
const Navbar = () => {
  ...
  const { connect, address, getShortAddress } = useStateContext();
      ...
      <div className="sm:flex hidden flex-row justify-end gap-4">
        ...
        <Link to="/profile">
          <div className="w-[52px] h-[52px] rounded-full bg-[#2c2f32] flex justify-center items-center cursor-pointer">
            <div className="w-[60%] h-[60%] bg-[#8c6dfd] rounded-full flex items-center justify-center text-white font-bold text-[10px]">
